...
def populate():
    data = [
        {
            "title": "Estimation & Quantity Take-Off Services", # Updated to match slug or keep consistent
        ...
        },
        {
            ...
            "icon": "fa-solid fa-cabinet-filing", # Hypothetical icon
    ...
    for idx, item in enumerate(data):
        ...
        # Clear existing dynamic content to avoid duplication on re-run
        service.sections.all().delete()
        service.features.all().delete()
        # Note: We are keeping images if they exist, or we could add default ones below
        ...
        # Add basic gallery images if none exist (using the main image as a placeholder for now)

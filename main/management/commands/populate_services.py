...
class Command(BaseCommand):
    help = 'Populates the database with initial service data'

    def handle(self, *args, **kwargs):
        self.stdout.write("Deleting all existing services...")
        ...
        data = [
            ...
            },
            {
                ...
                "features": [
                    ("Architectural Floor Plans, Elevations & Sections", "fa-solid fa-building"),
                    ("Construction & Permit Drawings", "fa-solid fa-file-signature"),
                    ("Mechanical, Electrical & Plumbing (MEP) Drafting", "fa-solid fa-bolt"),
                    ("Shop Drawings & As-Built Drawings", "fa-solid fa-clipboard-check"),
                    ("PDF / Hand Sketch to AutoCAD Conversion", "fa-solid fa-file-pdf"),
                    ("3D Architectural & Structural Models", "fa-solid fa-cube"),
                    ("Mechanical Parts & Assembly Modeling", "fa-solid fa-gears"),
                    ("Product & Industrial 3D Models", "fa-solid fa-box-open"),
                    ("Interior & Exterior 3D Visualization", "fa-solid fa-eye"),
                    ("Concept & Presentation Models", "fa-solid fa-lightbulb")
                ]
            },
            {
